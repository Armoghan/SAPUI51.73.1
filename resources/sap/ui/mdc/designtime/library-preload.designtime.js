 ...
 */
sap.ui.predefine('sap/ui/mdc/designtime/FilterBar.designtime',[],function(){"use strict";return{name:"{name}",description:"{description}",aggregations:{filterItems:{ignore:true},basicSearchField:{ignore:true}}};},false);
sap.ui.predefine('sap/ui/mdc/designtime/Table.designtime',[],function(){"use strict";return{name:"{name}",description:"{description}",aggregations:{columns:{ignore:true}}};},false);
